...
const CELLO_SAMPLE_CENTS_ADJUSTMENT: number = NO_SHIFT + SHIFT_AVERAGE_SAMPLE_PITCH_OF_C5_TO_BASE_PITCH
const DOUBLEBASS_SAMPLE_CENTS_ADJUSTMENT: number = TWO_OCTAVES + SHIFT_AVERAGE_SAMPLE_PITCH_OF_C5_TO_BASE_PITCH
const FLUTE_SAMPLE_CENTS_ADJUSTMENT: number = NO_SHIFT + SHIFT_AVERAGE_SAMPLE_PITCH_OF_C5_TO_BASE_PITCH
const PIANO_SAMPLE_CENTS_ADJUSTMENT: number = -TWO_OCTAVES + SHIFT_AVERAGE_SAMPLE_PITCH_OF_C5_TO_BASE_PITCH
const TROMBONE_SAMPLE_CENTS_ADJUSTMENT: number = TWO_SEMITONES + SHIFT_AVERAGE_SAMPLE_PITCH_OF_C5_TO_BASE_PITCH
const TRUMPET_SAMPLE_CENTS_ADJUSTMENT: number = -ONE_SEMITONE + SHIFT_AVERAGE_SAMPLE_PITCH_OF_C5_TO_BASE_PITCH
const TUBA_SAMPLE_CENTS_ADJUSTMENT: number = ONE_OCTAVE + SHIFT_AVERAGE_SAMPLE_PITCH_OF_C5_TO_BASE_PITCH
const VIOLIN_SAMPLE_CENTS_ADJUSTMENT: number = NO_SHIFT + SHIFT_AVERAGE_SAMPLE_PITCH_OF_C5_TO_BASE_PITCH
